...
Quando há diferentes amostras para a mesma localização (latitude e longitude), uma média da frequência ponderada pelo tamanho amostral é calculada.
...
Os pontos de cada amostragem são projetados no mapa. Para pontos muito próximos, é tomada uma média das frequências.
